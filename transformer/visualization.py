...
from train import AttentionMURAClassifier, MarginWeightedBCELoss
...
def main():
    ...
    try:
        ...
        criterion = MarginWeightedBCELoss(abnormal_count=num_abnormal, normal_count=num_normal).to(device)
    except:
        criterion = None
